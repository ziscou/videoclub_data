...
public class CategoriaController {
    ...
    @GetMapping({"","/"})
    public List<Categoria> all(@RequestParam("buscar")Optional<String> busOpt,
                               @RequestParam("ordenar")Optional<String> odrOpt) {
        log.info("Accediendo a todas las categorias");
        return this.categoriaService.allFilter(busOpt, odrOpt);
    }
